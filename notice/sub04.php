...
<body>
    ...
    <div class="wrap">
        <section class="kr_main-page notice-page sub04">
                                                ...
                                                <table class="row-table">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="rt02">지역</th>
                                                            <th class="rt03">제목</th>
                                                            <th class="rt04">작성자</th>
                                                            <th class="rt05">첨부</th>
                                                            <th class="rt06">작성일</th>
                                                            <th class="rt07">조회</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="news_location">경기<br> (성남, 의정부)</td>
                                                            <td class="news_subject">
                                                                <a href="<?=DIR?>/common/notice_view.php">2023년 제2차 KF(Korea Foundation) 교육분야 해외유력인사 한국대학교육협</a>
                                                            </td>
