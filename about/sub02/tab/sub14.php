...
<body>
    ...
    <div class="wrap">
        <section class="kr_main-page about-page sub02-wrap under14">
                    ...
                    <div class="contents">
                        <div class="row">
                            ...
                            <div class="row-contents">
                                <div class="row">
                                    <div class="imgBox">
                                        <img src="<?=DIR?>/img/about/mainbusiness1.jpg" alt="주요사업 이미지">
                                        <img src="<?=DIR?>/img/about/mainbusiness2.jpg" alt="주요사업 이미지">
                                    </div>
                                </div>
                            </div>
                        </div>
